...
public class Editor extends javax.swing.JPanel {
    ...
    public void initPantalla(Pantalla pant){
        pantalla = pant;
    }

    public boolean getModificado(){
        Programa temp;
        temp = (Programa) programas.getSelectedComponent();
        return temp.getModificado();
    }

    public void nuevoPrograma(){
        Programa temp = new Programa(pantalla);
        temp.initPrograma();
    ...
    public void abrirPrograma(){
        ...
        if(valor==aux.APPROVE_OPTION){
            ...
            if(indice<0){
                ...
                temp.setDirectorio(archivo.getParent());
                programas.setSelectedComponent(temp);
                pantalla.setCleanViewMsg();
                temp.setFocusCodigo();
                directorio = temp.getRuta();
            }
            else{
              ...
              Programa temp2;
              temp2 = (Programa) programas.getComponentAt(indice);
...
// Busca entre los programas abiertos en el editor, si ya se abrió el archivo
    ...
    for(int i=0; i<total; i++){
      temp = (Programa) programas.getComponentAt(i);
    ...
    public void guardarPrograma(Programa temp, int index){
        if(temp.existeRuta()){
            temp.guardar(temp.getRuta());
        }
        else
    ...
    public void guardarComoPrograma(Programa temp, int index){
        File archivo = null;
        JFileChooser aux = new JFileChooser();
        aux.setDialogTitle("Guardar como...");
        // Especificar el directorio sobre el que se está trabajando
  ...
  BorderLayout borderLayout1 = new BorderLayout();
    ...
    this.add(programas,  BorderLayout.CENTER);
  }
  ...
  public String getNombrePrograma(){
    Programa temp;
    temp = (Programa) programas.getSelectedComponent();
    return temp.getNombrePrograma();
  }

  public String getDirectorio(){
    Programa temp;
    temp = (Programa) programas.getSelectedComponent();
    return temp.getDirectorio();
  }
