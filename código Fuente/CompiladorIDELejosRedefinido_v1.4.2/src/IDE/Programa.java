...
//                        if(xKey==17) deshacer();
  ...
  public void refreshStatusBar(){
      if(AnalizadorLexico.idioma==1)pantalla.setStatusBarLinea("Línea:" + nf.format(lineaActual) + " Columna:" + nf.format(columActual));
      else{pantalla.setStatusBarLinea("Line:" + nf.format(lineaActual) + " Column:" + nf.format(columActual));}
